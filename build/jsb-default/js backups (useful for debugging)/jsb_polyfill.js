...
"./cocos2d/core/platform/CCEnum": 104
} ],
3: [ (function(t, e, i) {}), {} ],
4: [ (function(t, e, i) {
...
var B = new n(L);
B.computeBeziers();
for (var F = B.progresses; 1 - O > 1e-6; ) {
var M, j, z, k;
if ((C = c(C = O, w)) < 0) {
k = (0 - C) * (j = B.beziers[0]).getLength();
z = j.start.sub(j.endCtrlPoint).normalize();
M = j.start.add(z.mul(k));
} else if (C > 1) {
k = (C - 1) * (j = B.beziers[B.beziers.length - 1]).getLength();
...
"../label/CCHtmlTextParser": 82,
"../label/CCTextUtils": 83
} ],
57: [ (function(t, e, i) {
...
"./CCSlider": 60,
"./CCSprite": 61,
"./CCSpriteDistortion": 62,
"./CCToggle": 64,
"./CCToggleContainer": 65,
"./CCToggleGroup": 66,
"./CCVideoPlayer": 1,
"./CCWebView": 68,
"./CCWidget": 69,
...
"./asset-loader": 85,
"./asset-table": 86,
"./auto-release-utils": 87,
"./downloader": 88,
"./loader": 91,
"./loading-items": 92,
"./pipeline": 95,
"./released-asset-checker": 96
} ],
85: [ (function(t, e, i) {
...
"../load-pipeline/auto-release-utils": 87,
"../load-pipeline/md5-pipe": 93,
"../load-pipeline/pack-downloader": 94,
"../utils/decode-uuid": 126,
"./utils": 122
} ],
102: [ (function(i, n, o) {
function r(t, e) {
...
"./cocos2d/core": 81,
"./cocos2d/core/components/CCStudioComponent": 63,
"./cocos2d/deprecated": 142,
"./cocos2d/motion-streak/CCMotionStreak": 1,
"./cocos2d/particle/CCParticleAsset": 143,
"./cocos2d/particle/CCParticleSystem": 144,
"./cocos2d/tilemap/CCTiledMap": 1,
"./cocos2d/tilemap/CCTiledMapAsset": 1,
"./extensions/ccpool/CCNodePool": 146,
"./extensions/ccpool/CCPool": 147,
"./extensions/dragonbones": 1,
"./extensions/spine": 151,
"./external/chipmunk/chipmunk": 152
} ],
146: [ (function(t, e, i) {
...
var s = i - o, c = n - r, a = m(E(s, c, t - o, e - r) / M(s, c));
return new b(o + s * a, r + c * a);
};
cp.momentForCircle = function(t, e, i, n) {
return t * (.5 * (e * e + i * i) + F(n));
};
...
return cp.momentForBox(t, i, n) + t * F(o);
};
...
return O(e, T(t, e) / F(e));
});
b.prototype.project = function(t) {
this.mult(T(this, t) / F(t));
return this;
};
var D = cp.v.rotate = function(t, e) {
...
var i = this.tc = D(this.c, e).add(t), n = this.r;
this.bb_l = i.x - n;
this.bb_b = i.y - n;
this.bb_r = i.x + n;
this.bb_t = i.y + n;
...
this.ta = x(t, D(this.a, e));
this.tb = x(t, D(this.b, e));
this.tn = D(this.n, e);
var i, n, o, r;
...
return this.getVelAtPoint(D(t, this.rot));
};
...
return x(this.p, D(t, this.rot));
};
rt.prototype.world2Local = function(t) {
return B(w(t, this.p), this.rot);
};
...
var i = e.ta, n = e.tb, o = t.tc, r = w(n, i), s = m(T(r, w(o, i)) / F(r)), c = x(i, O(r, s)), a = Pt(o, c, t.r, e.r);
if (a) {
var h = a.n;
...
var a = 0, h = Mt(t, n[0].n, n[0].d);
if (h > 0) return Rt;
for (var l = 0; l < o; l++) {
var d = Mt(t, n[l].n, n[l].d);
if (d > 0) return Rt;
if (d > h) {
h = d;
a = l;
...
var i = Bt(e, t.tPlanes);
if (-1 == i) return Rt;
var n = Dt, o = Bt(t, e.tPlanes);
if (-1 == o) return Rt;
var r = Dt;
return n > r ? Ft(t, e, t.tPlanes[i].n, n) : Ft(t, e, I(e.tPlanes[o].n), r);
} ];
...
if (e) {
var r = this.idleSpeedThreshold, s = r ? r * r : F(this.gravity) * t * t;
...
this.anchr1 = i;
this.anchr2 = n;
var o = t ? x(t.p, D(i, t.rot)) : i, r = e ? x(e.p, D(n, e.rot)) : n;
this.dist = S(w(r, o));
...
this.r1 = D(this.anchr1, e.rot);
this.r2 = D(this.anchr2, i.rot);
...
var e = this.a, i = this.b, n = e.local2World(this.grv_a), o = e.local2World(this.grv_b), r = D(this.grv_n, e.rot), s = T(n, r);
this.grv_tn = r;
this.r2 = D(this.anchr2, i.rot);
...
"../CCDebugger": 2,
"../DebugInfos": 3,
"../cocos2d/core/event": 77,
"../cocos2d/core/event-manager/CCEvent": 72,
"../cocos2d/core/event-manager/CCSystemEvent": 73,
"../cocos2d/core/platform/CCMacro": 105,
"../cocos2d/core/platform/js": 118,
"../cocos2d/core/utils/find": 127,
"../cocos2d/core/utils/mutable-forward-iterator": 129,
"../cocos2d/core/value-types": 141,
"../extends": 145,
"../polyfill/misc": 170,
"../polyfill/string": 171,
"../polyfill/typescript": 172,
"./jsb-action": 154,
"./jsb-audio": 155,
"./jsb-box2d": 1,
"./jsb-director": 156,
...
"./jsb-loader": 163,
"./jsb-particle": 164,
"./jsb-scale9sprite": 165,
"./jsb-spine": 166,
"./jsb-tex-sprite-frame": 167,
"./jsb-tiledmap": 168,
"./jsb-videoplayer": 1,
"./jsb-webview": 169
} ],
...
"../cocos2d/core/component-scheduler": 38,
"../cocos2d/core/event/event-listeners": 74,
"../cocos2d/core/load-pipeline/auto-release-utils": 87,
"../cocos2d/core/node-activator": 100
} ],
157: [ (function(t, e, i) {
"use strict";
